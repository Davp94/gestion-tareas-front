                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        <div className="text-center mb-5">
                            <div className="text-900 text-3xl font-medium mb-3">GESTION TAREAS</div>
                        ...
                        <div>
                            ...
                            <InputText id="username" type="text" placeholder="Nombre de usuario" className="w-full md:w-30rem mb-5 p-3" onChange={(e) => setUsername(e.target.value)}/>
